/**
  ...
  ******************************************************************************
  * @remark
  * Funções TEMPLATE_Init e TEMPLATE_Receive modificadas; Funções VCP_read e
...
/**
  * @brief Função de leitura da Virtual COM Port
  */
int VCP_read(void *pBuffer, int size)
{
...
/**
  * @brief Função de escrita na Virtual COM Port
  */
int VCP_write(const void *pBuffer, int size)
{
